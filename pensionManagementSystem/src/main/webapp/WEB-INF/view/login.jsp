...
<body
	style="background-image: url(https://c1.wallpaperflare.com/preview/200/1006/321/money-home-coin-investment.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
	<header>
	...
	<section>
		<div class="container">
			...
			<div class="float-right" style="margin-top: 100px; background-color: rgba(255, 255, 255, 0.5);  width: 400px; box-shadow: 5px 10px 8px 10px #888888; padding: 30px; border-radius: 5mm;" >
				<div class="text-center text-dark font-italic">
					Retirement is not the end of the road.&nbsp;Its the beginning of open highway.
				</div>
			</div>
		</div>
	</section>

	<div class="navbar bg-dark footer transparent ">
		&copy; Copyright 2021
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i
